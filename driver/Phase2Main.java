...
public class Phase2Main {
    ...
    private static void testCurrentMarketPublisher() {
        try {
           ...
           try{ CurrentMarketPublisher.getInstance().publishCurrentMarket(mdo3);}
    ...
    private static void testLastSalePublisher() {
        try {
           ...
           try{ LastSalePublisher.getInstance().publishLastSale("GE", PriceFactory.makeLimitPrice("22.70"), 40);
           }
           catch(NoSubscribeException e)
           {
        	   System.out.println(e.getMessage());
    ...
    private static void testMessagePublisher() {
        ...
        try {
           ...
           try{ MessagePublisher.getInstance().publishCancel(cm);}
           catch(NoSubscribeException e)
           {
        	   System.out.println(e.getMessage());
           }
           ...
           try{ MessagePublisher.getInstance().publishCancel(cm2);}
           catch(NoSubscribeException e)
           {
        	   System.out.println(e.getMessage());
           }
            ...
            try{MessagePublisher.getInstance().publishCancel(cm4);}
            catch(NoSubscribeException e){
            	System.out.println(e.getMessage());
            }
            System.out.println();
            ...
            try{MessagePublisher.getInstance().publishFill(fm2);}
            catch(NoSubscribeException e){
            	System.out.println(e.getMessage());
            }
            System.out.println();
            ...
            try{MessagePublisher.getInstance().publishFill(fm4);}
            catch(NoSubscribeException e){
            	System.out.println(e.getMessage());
            }
            System.out.println(); 
